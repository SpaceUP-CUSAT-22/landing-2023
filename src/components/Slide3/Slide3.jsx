    ...
    const speakers = [
        {
            ...
            desc: "We are honored to announce Dr. Tessy Thomas as the Chief Guest and our First Keynote Speaker for SpaceUp CUSAT 2023. Known as the 'Missile Woman of India,' Dr. Tessy Thomas has made an indelible mark in the field of aerospace and defense. As the former Director of the Advanced Systems Laboratory (ASL) and Project Director for Agni-IV, she played a pivotal role in India's strategic missile program. Her exceptional contributions to missile technology and defense systems have not only elevated India's capabilities but also inspired countless individuals, especially women, to pursue careers in science and technology. Dr. Thomas's keynote address promises to be an enlightening and inspiring start to our event, setting the stage for an incredible day of space exploration discussions and insights. Don't miss the opportunity to hear from this visionary leader at SpaceUp CUSAT on October 14, 2023.",
            img1: tessy1,
            img2: tessy2,
            subname1: "TESSY",
            subname2: "THOMAS",
        },
        {
            ...
            location: "Kerala, India",
            desc: "We are privileged to welcome Dr. Brindha V, the Director (DSRQ) at the Indian Space Research Organisation (ISRO), as one of our esteemed speakers at SpaceUp CUSAT 2023. With her leadership at the helm of ISRO's Department of Space Research and Quantum Physics, Dr. Brindha has been instrumental in shaping India's space research landscape. Her remarkable career spans pivotal roles in advancing space technology and quantum physics research. Dr. Brindha's insights and vision for the future of space research and exploration will undoubtedly captivate our audience. Join us in extending a warm welcome to Dr. Brindha V, Director (DSRQ) at ISRO, at SpaceUp CUSAT on October 14, 2023, for an illuminating discussion on India's contributions to the world of space science and technology.",
            img1: brindha1,
            img2: brindha2,
            subname1: "BRINDHA",
            subname2: "V",
        },
        {
            ...
            location: "Kerala, India",
            desc: "We are pleased to introduce Dr. Vaisakhan Thampi, a multi-talented educator, researcher, and popular science YouTuber, as one of our esteemed speakers at SpaceUp CUSAT 2023. With a deep-rooted passion for science and education, Dr. Vaisakhan wears many hats in his career. He is not only an Assistant Professor in Physics at M G College, Thiruvananthapuram but also holds a PhD in Materials Science from the National Institute for Interdisciplinary Science and Technology (NIIST). Dr. Vaisakhan's scholarly contributions are commendable, having published seven research articles, authored five popular science books, and contributed to numerous articles in newspapers and magazines. Dr. Vaisakhan Thampi's multifaceted expertise and passion for science communication promise to make his presentation at SpaceUp CUSAT on October 14, 2023, an enlightening and engaging experience for all attendees.",
            img1: vais1,
            img2: vais2,
            subname1: "Vaisakhan",
            subname2: "Thampi",
