    ...
    return (
        <div ref={componentRef} id="info" className='component relative z-30 bg-white max-w-full overflow-hidden'>
            <div className="flex flex-col lg:flex-row gap-x-24 gap-y-6 my-24 mx-8 md:mx-12 lg:mx-20 border-b-2 pb-6">
                ...
                <div className="flex flex-1 justify-center items-center text-left lg:pt-5 text-sm sm:text-base font-normal font-satoshi">SpaceUp isn't your typical conference; it's a global phenomenon that empowers you to shape the future of space networking. Since its groundbreaking debut in 2010, SpaceUp has transcended borders, becoming a worldwide sensation. Our mission? To revolutionize networking in the space industry. At SpaceUp, we believe that everyone with a space passion deserves a platform to shine. That's why we let YOU decide the agenda. No pre-set topics or schedules - you're in control! Picture this: Attendees collaboratively build the event in real-time. They propose topics, lead discussions, and form the audience on the spot. There are no spectators, only participants! SpaceUp is the ultimate melting pot, uniting diverse space communities, fostering careers, and sparking fresh ideas for space startups. Join us, and be part of the space revolution!
                </div>
            </div>
